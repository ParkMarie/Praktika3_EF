...
namespace Praktika3_EF.BookStoreDataSetTableAdapters {
...
SELECT ID_Book, NameOfBook, Author, Price FROM Books WHERE (ID_Book = @ID_Book)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Praktika3_EF.Properties.Settings.Default.BookStoreConnectionString;
        }
...
INNER JOIN [Customers] ON [Orders].[Customer_ID] = [Customers].[ID_Customer]";
        ...
        public virtual BookStoreDataSet.OrderInfoDataTable GetDataFullInfo() {
